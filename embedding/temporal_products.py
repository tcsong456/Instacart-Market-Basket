...
def data_processing(data,save=False):
    path = 'data/user_product_info.csv'
    try:
...
def trainer(data,
    ...
    agg_data = data_processing(data,save=True)
...
agg_data = pd.read_csv('data/user_product_info.csv')
# z = agg_data.iloc[:1000]
# z = data.iloc[1000000:10000000]
agg_data.loc[10,'reordered']
